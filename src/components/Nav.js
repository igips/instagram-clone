...
function Nav() {
	...
	function profileIcon() {
		...
		if (user) {
			return (
				<span onClick={() => avatarIcon()} role="link" tabIndex="0" style={{ width: "24px", height: "24px" }}>
					<img id="ava" alt="" crossOrigin="anonymous" draggable="false" src={ava} />
				</span>
			);
		} else {
			return (
				<svg
					onClick={() => profileIconCheck()}
					stroke="currentColor"
					fill="currentColor"
					strokeWidth="0"
					viewBox="0 0 512 512"
		...
		<>
					...
					<div className="nav-inner-container">
						...
						<div id="icon-div">
							...
							<div
								...
								className="icon-inner-div icon-to-hide notification-svg"
							>
								<svg
			...
			<nav id="bottom-nav">
				<div className="nav-container-bottom">
					...
					<div onClick={() => notificationIcon()} className="icon-inner-div inner-bottom notification-svg">
						<svg
							aria-label="Activity Feed"
							color="#262626"
							fill="#262626"

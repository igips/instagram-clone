				...
				<section className="add-comment-section">
					<div className="add-comment-section-inner">
						<form onSubmit={(e) => submitComment(e)} className="comment-form">
							...
							<textarea value={commentValue} onChange={(e) => handleCommentTextAreaChange(e)} placeholder="Add a comment…" className="add-comment-text-area"></textarea>
							<button id={id + "button"} className="post-div" disabled>Post</button>
						</form>
					</div>
				</section>
			);
					...
					<div className="pic-comments-div">
						<div className="pic-comments-inner-div">
							<div className="comment-line-div">
								<div>
									<span className="name-span in-coms">blabeksrapek</span>
							...
							<div className="comment-line-div">
								<div className="comment-line-inner-div">
									<span className="name-span in-coms">kristencor</span>
							...
							<div className="comment-line-div">
								<div className="comment-line-inner-div">
									<span className="name-span in-coms">labrakonks</span>
